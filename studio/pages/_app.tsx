          ...
          <Hydrate state={pageProps.dehydratedState}>
            <AuthProvider>
              ...
              >
                <ProfileProvider>
                  <Head>
                    <title>{appTitle ?? 'RuVector Studio'}</title>
                    <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                    <meta property="og:image" content={`${BASE_PATH}/img/ruvector-logo.svg`} />
                  ...
                  <MetaFaviconsPagesRouter applicationName="RuVector Studio" includeManifest />
